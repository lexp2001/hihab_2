...
router.post('/', function(req, res, next) {
    ...
    "<span style='font-size:13px;'><b>Hola [Nombre], gracias por tu interés en hi:hab</span></b><br><br>" +
    "Mi nombre es Hugo y me encargo de las relaciones entre hi:hab y los socios dueños " +
    "de terrenos, nuestro sistema ha corroborado la información de tu lote en: [dirección], " +
    "con Clave de Catastro: [clave catastro]. <br><br>" +

    "En base a nuestros cálculos, la superficie de tu terreno de [superficie]m2, con un " +
    "frente de: [frente]m, que actualmente cuenta con una superficie construida de: " +
    "[superficie construida]m2 de [edad de construcción] años de construcción, de la cual " +
    "eres [relación con lote], cuenta con un uso de suelo [uso de suelo] y permiso de " +
    "construcción para hasta [niveles]niveles por lo que es apta para un desarrollo hi:hab " +
    "de [#camas].<br><br>" +
    ...
    "<strong>[calculo algoritmo]</strong></span>" +
    ...
    "<td><span style='font-size=13px;line-height:28px;'>" +
    "<strong>[valor de renta]</strong></span>" +
    "<strong><span style=\"font-weight: 400;\"><br>" +
